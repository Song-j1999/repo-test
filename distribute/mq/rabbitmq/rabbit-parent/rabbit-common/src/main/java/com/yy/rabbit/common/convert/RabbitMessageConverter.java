...
//		messageProperties.setExpiration(delaultExprie);
		com.yy.rabbit.api.Message message = (com.yy.rabbit.api.Message)object;
	...
	public Object fromMessage(Message message) throws MessageConversionException {
		com.yy.rabbit.api.Message msg = (com.yy.rabbit.api.Message) this.delegate.fromMessage(message);
		return msg;
	}
